...
class EditModemManual(ConfigListScreen, Screen):
	...
	skin = 	"""
		<screen position="center,center" size="600,360" title="3G Modem Manager Config Edit">
			...
			<widget name="VKeyIcon" pixmap="buttons/key_text.png" position="50,200" zPosition="10" size="35,25" transparent="1" alphatest="on" />
			<widget name="HelpWindow" pixmap="vkey_icon.png" position="%d,%d" zPosition="1" size="1,1" transparent="1" alphatest="on" />
		</screen>
		""" % param
